      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <NuxtLink
            ...
            :key="ville.slug"
            :to="`/zones/${ville.slug}`"
            class="group bg-stone-50 hover:bg-blue-50 border border-stone-100 hover:border-blue-300 rounded-xl p-4 transition-all"
          >
            <div class="flex items-start justify-between">
              <div>
                <div class="font-semibold text-stone-900 group-hover:text-blue-800 transition-colors">{{ ville.nom }}</div>
              ...
              <UIcon
                ...
                class="text-stone-300 group-hover:text-blue-500 transition-colors mt-0.5"
              />
            </div>
          </NuxtLink>
        </div>

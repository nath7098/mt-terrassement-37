    ...
    <section class="hero-gradient text-white py-16">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <h1 class="text-4xl md:text-5xl font-bold mb-4">
          Contact &<br><span style="color: #D4884D">Devis gratuit</span>
        </h1>
      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8">
          <div class="md:col-span-2">
            <div
              v-if="submitted"
              class="bg-blue-50 border border-blue-200 rounded-2xl p-8 text-center"
            >
              <UIcon
                name="i-lucide-check-circle"
                class="text-blue-600 text-4xl mx-auto mb-4"
              />
              ...
              <ul class="space-y-3 text-sm text-stone-700">
                <li class="flex items-start gap-2">
                  <UIcon
                    ...
                    style="color: #1B3A6B"
                  />
                  <span>24 rue des Rabatteries<br>37230 Fondettes</span>
                </li>
                <li class="flex items-start gap-2">
                  <UIcon
                    name="i-lucide-clock"

...
export const villes: Record<string, Ville> = {
  'tours': {
    ...
    metaDescription: 'Terrassement à Tours (37000) — MT 37 Terrassement. Excavation, nivellement, remblaiement. Devis gratuit. Intervention rapide dans tout le 37.',
    typeSol: 'Tuffeau et argile',
    pointFort: 'Zone urbaine dense — maîtrise des chantiers en milieu contraint',
    contenuUnique: `Tours, préfecture d'Indre-et-Loire avec ses 136 000 habitants, est notre zone d'intervention principale pour toutes les prestations de terrassement. MT 37 Terrassement intervient sur l'ensemble de la ville de Tours, du centre historique aux quartiers périphériques comme Deux-Lions, Sanitas, Rabelais et Prébendes.
...
En tant qu'entreprise de terrassement implantée en Indre-et-Loire, nous intervenons rapidement sur Tours et sa métropole. Contactez MT 37 Terrassement pour un devis gratuit et personnalisé pour votre projet de terrassement à Tours.`
  },
  'fondettes': {
    slug: 'fondettes',
    nom: 'Fondettes',
...
Contactez MT 37 Terrassement pour obtenir un devis gratuit pour votre projet de terrassement, excavation ou nivellement à Fondettes. Nous vous accompagnons de la conception à la réalisation.`
  },
  'joue-les-tours': {
    slug: 'joue-les-tours',
    nom: 'Joué-lès-Tours',
    ...
    metaDescription: 'Terrassement à Joué-lès-Tours (37300) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Intervention rapide en Indre-et-Loire.',
    typeSol: 'Limon et argile',
    pointFort: 'Forte croissance résidentielle — expertise en viabilisation de lotissements',
    contenuUnique: `Joué-lès-Tours, deuxième ville la plus peuplée d'Indre-et-Loire avec 38 000 habitants, représente un secteur d'activité majeur pour MT 37 Terrassement. Cette commune en plein développement connaît une forte dynamique de construction et de rénovation qui nécessite des travaux de terrassement réguliers.
...
Pour vos travaux de terrassement à Joué-lès-Tours en Indre-et-Loire, contactez MT 37 Terrassement. Devis gratuit et intervention rapide garantis.`
  },
  'bourgueil': {
    slug: 'bourgueil',
    nom: 'Bourgueil',
    ...
    metaDescription: 'Terrassement à Bourgueil (37140) — MT 37 Terrassement. Excavation, nivellement & remblaiement. Devis gratuit. Entreprise locale en Indre-et-Loire.',
...
MT 37 Terrassement intervient à Bourgueil avec le même niveau de professionnalisme que dans l'agglomération tourangelle. Nos équipes s'adaptent aux spécificités locales, notamment les accès parfois étroits dans les zones viticoles et les contraintes liées à la préservation du patrimoine.
...
Contactez MT 37 Terrassement pour vos travaux de terrassement, excavation ou nivellement à Bourgueil et dans le secteur de l'appellation. Devis gratuit, intervention rapide.`
  },
  'la-ville-aux-dames': {
    ...
    metaDescription: 'Terrassement à La Ville-aux-Dames (37700) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Intervention rapide en Indre-et-Loire.',
    typeSol: 'Alluvions ligériennes',
    pointFort: 'Terrains de vallée — maîtrise du drainage et des nappes superficielles',
    contenuUnique: `La Ville-aux-Dames, commune de 5 200 habitants à l'est de Tours, bénéficie des services de terrassement professionnel de MT 37 Terrassement. Cette ville résidentielle en développement, proche de la vallée de la Loire, connaît une activité de construction et de rénovation régulière.
...
Pour un devis gratuit concernant vos travaux de terrassement à La Ville-aux-Dames, contactez MT 37 Terrassement. Professionnalisme et réactivité sont nos engagements en Indre-et-Loire.`
  },
  'chinon': {
    slug: 'chinon',
    nom: 'Chinon',
    ...
    metaDescription: 'Terrassement à Chinon (37500) — MT 37 Terrassement. Excavation, nivellement & remblaiement. Devis gratuit. Entreprise locale 37.',
...
Contactez MT 37 Terrassement pour vos projets de terrassement, excavation ou nivellement à Chinon. Devis gratuit et intervention rapide dans tout le sud-ouest du département 37.`
  },
  'langeais': {
    slug: 'langeais',
    nom: 'Langeais',
    ...
    metaDescription: 'Terrassement à Langeais (37130) — MT 37 Terrassement. Excavation, nivellement, remblaiement. Devis gratuit. Intervention rapide en Indre-et-Loire.',
    typeSol: 'Tuffeau et alluvions',
    pointFort: 'Maîtrise des terrains de coteau et de plaine alluviale',
    contenuUnique: `Langeais, petite ville de 4 200 habitants entre Tours et Chinon, célèbre pour son château du XVe siècle, bénéficie du service de terrassement professionnel de MT 37 Terrassement. Cette commune en bord de Loire connaît une activité de construction et de rénovation régulière.
...
Pour vos travaux de terrassement à Langeais, faites confiance à MT 37 Terrassement. Contactez-nous pour un devis gratuit et personnalisé. Intervention rapide dans toute l'Indre-et-Loire.`
  },
  'chateaurenault': {
    slug: 'chateaurenault',
    nom: 'Châteaurenault',
...
Contactez MT 37 Terrassement pour vos projets de terrassement à Châteaurenault. Devis gratuit, intervention rapide dans tout le nord de la Touraine.`
  },
  'montlouis-sur-loire': {
    ...
    metaDescription: 'Terrassement à Montlouis-sur-Loire (37270) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Intervention rapide en Indre-et-Loire.',
...
Contactez MT 37 Terrassement pour un devis gratuit concernant vos travaux de terrassement à Montlouis-sur-Loire. Professionnalisme et réactivité sont nos engagements en Indre-et-Loire.`
  },
  'chateau-la-valliere': {
    ...
    metaDescription: 'Terrassement à Château-la-Vallière (37330) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Entreprise locale 37.',
    typeSol: 'Sable et argile forestière',
    pointFort: 'Intervention en milieu rural et grandes propriétés',
    contenuUnique: `Château-la-Vallière, petite commune de 1 600 habitants dans le nord-ouest de l'Indre-et-Loire, bénéficie du service de terrassement professionnel de MT 37 Terrassement, même en zone rurale. Cette commune paisible, connue pour sa base de loisirs et son cadre naturel préservé, connaît une activité de terrassement principalement liée aux projets résidentiels.

MT 37 Terrassement s'engage à desservir Château-la-Vallière avec le même professionnalisme que dans les grandes communes du département. Nous comprenons les spécificités des zones rurales de l'Indre-et-Loire : chemins d'accès parfois étroits, propriétés dispersées, et besoins souvent liés à la rénovation de bâti ancien ou à l'aménagement de grandes propriétés.
...
Pour vos travaux de terrassement à Château-la-Vallière, contactez MT 37 Terrassement. Devis gratuit et intervention professionnelle garantis dans tout le département 37.`
  },
  'azay-le-rideau': {
    slug: 'azay-le-rideau',
    nom: 'Azay-le-Rideau',
    ...
    metaDescription: 'Terrassement à Azay-le-Rideau (37190) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Entreprise sérieuse en Indre-et-Loire.',
...
Contactez MT 37 Terrassement pour vos travaux de terrassement à Azay-le-Rideau. Expertise locale, respect de l'environnement et professionnalisme sont nos engagements dans tout le département 37.`
  },
  'notre-dame-doe': {
    slug: 'notre-dame-doe',
    nom: 'Notre-Dame-d\'Oé',
    ...
    metaDescription: 'Terrassement à Notre-Dame-d\'Oé (37390) — MT 37 Terrassement. Excavation, nivellement & remblaiement. Devis gratuit. Intervention rapide 37.',
    typeSol: 'Calcaire et argile',
    pointFort: 'Secteur en forte expansion résidentielle — terrains à bâtir',
    contenuUnique: `Notre-Dame-d'Oé, commune de 4 000 habitants au nord de l'agglomération tourangelle, bénéficie d'un service de terrassement de proximité avec MT 37 Terrassement. Cette ville résidentielle en plein développement connaît une forte activité de construction de maisons individuelles qui génère des besoins importants en terrassement.
...
Pour vos projets de terrassement, excavation ou nivellement à Notre-Dame-d'Oé, contactez MT 37 Terrassement. Devis gratuit, intervention rapide dans tout le nord de la Touraine.`
  },
  'savonnieres': {
    slug: 'savonnieres',
    nom: 'Savonnières',
    ...
    metaDescription: 'Terrassement à Savonnières (37510) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Entreprise de terrassement locale 37.',
...
Faites confiance à MT 37 Terrassement pour vos travaux de terrassement à Savonnières. Contactez-nous pour un devis gratuit et personnalisé. Intervention rapide dans toute l'Indre-et-Loire.`
  },
  'saumur': {
    slug: 'saumur',
    nom: 'Saumur',
    ...
    metaDescription: 'Terrassement à Saumur (49400) — MT 37 Terrassement. Excavation, nivellement, remblaiement. Devis gratuit. Entreprise locale de terrassement.',
    typeSol: 'Tuffeau saumurois',
    pointFort: 'Référence en excavation de caves troglodytiques et sous-sols en tuffeau',
    contenuUnique: `Saumur, ville de 26 500 habitants surnommée la "Perle de l'Anjou", bénéficie du service de terrassement professionnel de MT 37 Terrassement. Cette cité historique célèbre pour son château, son École de Cavalerie et ses vignobles, connaît une activité importante de construction et de rénovation.
...
Contactez MT 37 Terrassement pour vos projets de terrassement, excavation ou nivellement à Saumur. Devis gratuit, expertise locale reconnue et intervention professionnelle dans toute la région.`
  },
  'chatellerault': {
    slug: 'chatellerault',
    nom: 'Châtellerault',
    ...
    metaDescription: 'Terrassement à Châtellerault (86100) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Entreprise de terrassement Indre-et-Loire.',
    typeSol: 'Calcaire et alluvions de Vienne',
    pointFort: 'Expertise en terrains de grande vallée alluviale',
    contenuUnique: `Châtellerault, ville de 31 500 habitants dans la Vienne, proche de l'Indre-et-Loire, bénéficie du service de terrassement professionnel de MT 37 Terrassement. Cette cité industrielle et universitaire en bord de Vienne connaît une dynamique importante de rénovation urbaine et de développement immobilier.
...
Contactez MT 37 Terrassement pour vos travaux de terrassement à Châtellerault. Devis gratuit et intervention professionnelle garantis dans toute la région.`
  },
  'blois': {
    slug: 'blois',
    nom: 'Blois',
    ...
    metaDescription: 'Terrassement à Blois (41000) — MT 37 Terrassement. Excavation, nivellement & remblaiement. Devis gratuit. Entreprise locale de terrassement.',
...
MT 37 Terrassement intervient à Blois pour accompagner les particuliers et professionnels dans leurs projets de terrassement. Nous couvrons l'ensemble des quartiers blésois : du centre historique classé aux quartiers résidentiels de Vienne, Kennedy et de la Quinière.
...
Faites confiance à MT 37 Terrassement pour vos projets de terrassement, excavation ou nivellement à Blois. Devis gratuit, intervention professionnelle et réactivité garantis.`
  },
  'descartes': {
    slug: 'descartes',
    nom: 'Descartes',
    ...
    metaDescription: 'Terrassement à Descartes (37160) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Entreprise de terrassement en Indre-et-Loire.',
    typeSol: 'Alluvions de Creuse et calcaire',
    pointFort: 'Sud Touraine — intervention sur chantiers ruraux et agricoles',
    contenuUnique: `Descartes, petite ville de 3 800 habitants dans le sud de l'Indre-et-Loire, patrie du philosophe René Descartes, bénéficie du service de terrassement professionnel de MT 37 Terrassement. Cette cité en bord de Creuse connaît une activité régulière de rénovation de son patrimoine bâti ancien.
...
Contactez MT 37 Terrassement pour vos projets de terrassement à Descartes. Devis gratuit et intervention professionnelle garantis dans tout le sud de la Touraine.`
  },
  'loches': {
    slug: 'loches',
    nom: 'Loches',
    ...
    metaDescription: 'Terrassement à Loches (37600) — MT 37 Terrassement. Excavation, nivellement & remblaiement. Devis gratuit. Entreprise locale 37.',
    ...
    contenuUnique: `Loches, ville de 6 500 habitants dans le sud de l'Indre-et-Loire, est une cité royale médiévale classée Ville d'Art et d'Histoire. Son donjon du XIe siècle et son château royal font de Loches un joyau patrimonial de la Touraine dont MT 37 Terrassement s'attache à respecter le caractère exceptionnel dans ses interventions.
...
Faites confiance à MT 37 Terrassement pour vos travaux de terrassement à Loches. Devis gratuit, intervention professionnelle et réactivité garantis dans tout le sud de l'Indre-et-Loire.`
  },
  'loudun': {
    slug: 'loudun',
    nom: 'Loudun',
    ...
    metaDescription: 'Terrassement à Loudun (86200) — MT 37 Terrassement. Excavation & nivellement. Devis gratuit. Intervention professionnelle depuis l\'Indre-et-Loire.',
    typeSol: 'Calcaire et argile poitevine',
    pointFort: 'Expertise transfrontalière Touraine/Poitou',
    contenuUnique: `Loudun, ville de 6 700 habitants dans le nord de la Vienne, proche de l'Indre-et-Loire, bénéficie du service de terrassement professionnel de MT 37 Terrassement. Cette cité de caractère avec son histoire et son patrimoine Renaissance connaît une activité régulière de rénovation et de construction.
...
Contactez MT 37 Terrassement pour vos travaux de terrassement à Loudun. Devis gratuit et intervention professionnelle garantis dans toute la région limitrophe.`
  },
  'vendome': {
    slug: 'vendome',
    nom: 'Vendôme',
    ...
    metaDescription: 'Terrassement à Vendôme (41100) — MT 37 Terrassement. Excavation, nivellement & remblaiement. Devis gratuit. Entreprise de terrassement locale.',
...
MT 37 Terrassement étend son service à Vendôme pour accompagner les particuliers et professionnels dans leurs projets de terrassement. Nos équipes interviennent dans tous les quartiers de la ville : du centre historique aux quartiers résidentiels de Rochambeau, des Capucins et de Champ-Rouillé.
...
Contactez MT 37 Terrassement pour vos projets de terrassement, excavation ou nivellement à Vendôme. Devis gratuit, expertise locale reconnue et intervention rapide garantis.`
  }
}
